...
import type { LogMessage, LogFilter, LogLevel } from '../services/logService.js';
...
export interface ILogService {
  ...
  logActivity(message: string, membersInChannel?: string[], eventType?: string, metadata?: Record<string, any>): void;
