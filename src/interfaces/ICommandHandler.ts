...
export interface ICommandHandler {
  ...
  // 실행 제어
  executeCommand(commandName: string, interaction: ChatInputCommandInteraction): Promise<CommandExecutionResult>;
  ...
  getRateLimitStatus(userId: string): { limited: boolean; resetTime?: Date; remainingCalls?: number };
