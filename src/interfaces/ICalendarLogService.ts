...
export interface ICalendarLogService {
  ...
  logGapEvent(userId: string, gapType: string, details: Record<string, any>, date?: Date): Promise<void>;
  ...
  getUserActivityCalendar(userId: string, year: number, month: number): Promise<ActivityCalendarEntry[]>;
  ...
  filterEventsByType(eventType: string, startDate?: Date, endDate?: Date): Promise<CalendarEventData[]>;
  filterEventsByParticipant(userId: string, startDate?: Date, endDate?: Date): Promise<CalendarEventData[]>;
