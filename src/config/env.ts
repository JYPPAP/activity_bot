...
const logChannelId = getOptionalEnvVar('LOG_CHANNEL_ID'); // 이제 DB에서 우선 관리됨
...
if (process.env.NODE_ENV === 'development') {
  ...
  console.log(
    '   ✅ LOG_CHANNEL_ID, FORUM_CHANNEL_ID, VOICE_CATEGORY_ID, FORUM_TAG_ID는 GuildSettingsManager를 통해 DB에서 관리됩니다'
  );
...
export function validateConfig(): boolean {
  const requiredEnvVars: Array<keyof Config> = ['TOKEN', 'CLIENT_ID', 'POSTGRES_HOST', 'POSTGRES_PORT', 'POSTGRES_DB', 'POSTGRES_USER', 'POSTGRES_PASSWORD'];
